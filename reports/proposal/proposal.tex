...
\lhead{\headerfontlt{\textcolor{darkgray}{CAPP30254, Spring 19 \textcolor{gray}{$\big/$} Project Proposal \textcolor{gray}{$\big/$}} Combating Economic Blight}}
...
Cecile Murray \\
Jonathan Tan \\
Satej Soman \\ \vspace{20pt}
CAPP30254: Machine Learning for Public Policy\\
Spring 2019}}

\vspace{240pt}
\Huge\headerfontlt{\textcolor{darkgray}{COMBATING ECONOMIC BLIGHT}}
\vfill
\normalfont \normalsize
\tableofcontents
